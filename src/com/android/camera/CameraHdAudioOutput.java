...
/**
 * The CameraHdAudioOutput class manages and plays a single audio resource for Java applications.
 * It allows streaming of PCM audio buffers to the audio sink for playback. This is
 * achieved by "pushing" the data to the CameraHdAudioOutput object using one of the
 *  {@link #write(byte[], int, int)}, {@link #write(short[], int, int)},
 *  and {@link #write(float[], int, int, int)} methods.
 *
 * <p>An CameraHdAudioOutput instance can operate under two modes: static or streaming.<br>
 * In Streaming mode, the application writes a continuous stream of data to the CameraHdAudioOutput, using
 ...
 *
 * <p>Upon creation, an CameraHdAudioOutput object initializes its associated audio buffer.
 * The size of this buffer, specified during the construction, determines how long an CameraHdAudioOutput
 * can play before running out of data.<br>
 * For an CameraHdAudioOutput using the static mode, this size is the maximum size of the sound that can
 * be played from it.<br>
 * For the streaming mode, data will be written to the audio sink in chunks of
 * sizes less than or equal to the total buffer size.
 *
 * CameraHdAudioOutput is not final and thus permits subclasses, but such use is not recommended.
 */
public class CameraHdAudioOutput
{
    //---------------------------------------------------------
    // Constants
    //--------------------
    ...
    /** Maximum value for CameraHdAudioOutput channel count */
    private static final int CHANNEL_COUNT_MAX = 8;

    /** indicates CameraHdAudioOutput state is stopped */
    public static final int PLAYSTATE_STOPPED = 1;  // matches SL_PLAYSTATE_STOPPED
    /** indicates CameraHdAudioOutput state is paused */
    public static final int PLAYSTATE_PAUSED  = 2;  // matches SL_PLAYSTATE_PAUSED
    /** indicates CameraHdAudioOutput state is playing */
    public static final int PLAYSTATE_PLAYING = 3;  // matches SL_PLAYSTATE_PLAYING

    // keep these values in sync with android_media_CameraHdAudioOutput.cpp
    /**
    ...
    /**
     * State of an CameraHdAudioOutput that was not successfully initialized upon creation.
     */
    public static final int STATE_UNINITIALIZED = 0;
    /**
     * State of an CameraHdAudioOutput that is ready to be used.
     */
    public static final int STATE_INITIALIZED   = 1;
    /**
     * State of a successfully initialized CameraHdAudioOutput that uses static data,
    ...
    // Error codes:
    // to keep in sync with frameworks/base/core/jni/android_media_CameraHdAudioOutput.cpp
    ...
    // Events:
    // to keep in sync with frameworks/av/include/media/CameraHdAudioOutput.h
    /**
    ...
    private final static String TAG = "android.media.CameraHdAudioOutput";
    ...
    //--------------------
    /**
     * Indicates the state of the CameraHdAudioOutput instance.
     */
    private int mState = STATE_UNINITIALIZED;
    /**
     * Indicates the play state of the CameraHdAudioOutput instance.
     */
    ...
    /**
     * Looper associated with the thread that creates the CameraHdAudioOutput instance.
     */
    ...
    //--------------------
    /**
     * Accessed by native methods: provides access to C++ CameraHdAudioOutput object.
     */
    @SuppressWarnings("unused")
    private long mNativeTrackInJavaObj;
    /**
     * Accessed by native methods: provides access to the JNI data (i.e. resources used by
     * the native CameraHdAudioOutput object, but not stored in it).
     */
    @SuppressWarnings("unused")
     ...
     *   for the successful creation of an CameraHdAudioOutput instance in streaming mode. Using values
     *   smaller than getMinBufferSize() will result in an initialization failure.
     * @param mode streaming or static buffer. See {@link #MODE_STATIC} and {@link #MODE_STREAM}
     * @throws java.lang.IllegalArgumentException
     */
    public CameraHdAudioOutput(int streamType, int sampleRateInHz, int channelConfig, int audioFormat,
    ...
    /**
     * Class constructor with audio session. Use this constructor when the CameraHdAudioOutput must be
     * attached to a particular audio session. The primary use of the audio session ID is to
     * associate audio effects to a particular instance of CameraHdAudioOutput: if an audio session ID
     * is provided when creating an AudioEffect, this effect will be applied only to audio tracks
     * and media players in the same session and not to the output mix.
     * When an CameraHdAudioOutput is created without specifying a session, it will create its own session
     * which can be retrieved by calling the {@link #getAudioSessionId()} method.
     * If a non-zero session ID is provided, this CameraHdAudioOutput will share effects attached to this
     * session
     ...
     *   from for playback. If using the CameraHdAudioOutput in streaming mode, you can write data into
     *   this buffer in smaller chunks than this size. If using the CameraHdAudioOutput in static mode,
     *   this is the maximum size of the sound that will be played for this instance.
     *   See {@link #getMinBufferSize(int, int, int)} to determine the minimum required buffer size
     *   for the successful creation of an CameraHdAudioOutput instance in streaming mode. Using values
     *   smaller than getMinBufferSize() will result in an initialization failure.
     * @param mode streaming or static buffer. See {@link #MODE_STATIC} and {@link #MODE_STREAM}
     * @param sessionId Id of audio session the CameraHdAudioOutput must be attached to
     * @throws java.lang.IllegalArgumentException
     */
    public CameraHdAudioOutput(int streamType, int sampleRateInHz, int channelConfig, int audioFormat,
     ...
     *     that will be played through this CameraHdAudioOutput. See {@link AudioFormat.Builder} for
     ...
     *   smaller than getMinBufferSize() will result in an initialization failure.
     * @param mode streaming or static buffer. See {@link #MODE_STATIC} and {@link #MODE_STREAM}.
     * @param sessionId ID of audio session the CameraHdAudioOutput must be attached to, or
     *   {@link AudioManager#AUDIO_SESSION_ID_GENERATE} if the session isn't known at construction
     *   time. See also {@link AudioManager#generateAudioSessionId()} to obtain a session ID before
     *   construction.
     * @throws IllegalArgumentException
     */
    public CameraHdAudioOutput(AudioAttributes attributes, AudioFormat format, int bufferSizeInBytes,
        ...
        // remember which looper is associated with the CameraHdAudioOutput instantiation
        Looper looper;
        ...
        int initResult = native_setup(new WeakReference<CameraHdAudioOutput>(this), mAttributes,
                mSampleRate, mChannels, mAudioFormat,
                mNativeBufferSizeInBytes, mDataLoadMode, session);
        if (initResult != SUCCESS) {
            loge("Error code "+initResult+" when initializing CameraHdAudioOutput.");
     ...
     * @return false if the CameraHdAudioOutput can't be used with such a mask
     */
    ...
    /**
     * Releases the native CameraHdAudioOutput resources.
     */
    public void release() {
        // even though native_release() stops the native CameraHdAudioOutput, we need to stop
        // CameraHdAudioOutput subclasses too.
        try {
            stop();
    ...
    /**
     * Returns the type of audio stream this CameraHdAudioOutput is configured for.
    ...
    /**
     * Returns the state of the CameraHdAudioOutput instance. This is useful after the
     * CameraHdAudioOutput instance has been created to check if it was initialized
    ...
    /**
     * Returns the playback state of the CameraHdAudioOutput instance.
     ...
     *  @deprecated Only accessible by subclasses, which are not recommended for CameraHdAudioOutput.
     ...
     * to CameraHdAudioOutput buffer size, AudioMixer (if any) and audio hardware driver.
     *
    ...
    /**
     * Returns the minimum buffer size required for the successful creation of an CameraHdAudioOutput
     * object to be created in the {@link #MODE_STREAM} mode. Note that this size doesn't
     * guarantee a smooth playback under load, and higher values should be chosen according to
     * the expected frequency at which the buffer will be refilled with additional data to play.
     * For example, if you intend to dynamically set the source sample rate of an CameraHdAudioOutput
     ...
     *
     * @return the ID of the audio session this CameraHdAudioOutput belongs to.
     */
    ...
    */
    ...
    //--------------------
    /**
     * Sets the listener the CameraHdAudioOutput notifies when a previously set marker is reached or
     * for each periodic playback head position update.
     * Notifications will be received in the same thread as the one in which the CameraHdAudioOutput
     ...
     * Sets the listener the CameraHdAudioOutput notifies when a previously set marker is reached or
     * for each periodic playback head position update.
     * Use this method to receive CameraHdAudioOutput events in the Handler associated with another
     * thread than the one in which you created the CameraHdAudioOutput instance.
     * @param listener
    ...
    private static float clampGainOrLevel(float gainOrLevel) {
     ...
     /**
     * Sets the specified left and right output gain values on the CameraHdAudioOutput.
     ...
     * {@link #CameraHdAudioOutput(int, int, int, int, int, int)} constructor),
     ...
     * in an CameraHdAudioOutput subclass constructor to set a subclass-specific post-initialization state.
     * However, subclasses of CameraHdAudioOutput are no longer recommended, so this method is obsolete.
     * @param state the state of the CameraHdAudioOutput instance
     * @deprecated Only accessible by subclasses, which are not recommended for CameraHdAudioOutput.
     */
    @Deprecated
    ...
    //--------------------
    /**
     * Starts playing an CameraHdAudioOutput.
    ...
    throws IllegalStateException {
        if (mState != STATE_INITIALIZED) {
            throw new IllegalStateException("play() called on uninitialized CameraHdAudioOutput.");
        }
        if (isRestricted()) {
            setVolume(0);
        }
    ...
    throws IllegalStateException {
        if (mState != STATE_INITIALIZED) {
            throw new IllegalStateException("stop() called on uninitialized CameraHdAudioOutput.");
        }
    ...
    throws IllegalStateException {
        if (mState != STATE_INITIALIZED) {
            throw new IllegalStateException("pause() called on uninitialized CameraHdAudioOutput.");
        }
        //logd("pause()");
     ...
     *    {@link AudioManager#ERROR_DEAD_OBJECT} if the CameraHdAudioOutput is not valid anymore and
    ...
    public int write(float[] audioData, int offsetInFloats, int sizeInFloats,
        ...
        if (mState == STATE_UNINITIALIZED) {
            Log.e(TAG, "CameraHdAudioOutput.write() called in invalid state STATE_UNINITIALIZED");
            return ERROR_INVALID_OPERATION;
        }

        if (mAudioFormat != AudioFormat.ENCODING_PCM_FLOAT) {
            Log.e(TAG, "CameraHdAudioOutput.write(float[] ...) requires format ENCODING_PCM_FLOAT");
            return ERROR_INVALID_OPERATION;
        }

        if ((writeMode != WRITE_BLOCKING) && (writeMode != WRITE_NON_BLOCKING)) {
            Log.e(TAG, "CameraHdAudioOutput.write() called with invalid blocking mode");
            return ERROR_BAD_VALUE;
        }
        ...
        if ( (audioData == null) || (offsetInFloats < 0 ) || (sizeInFloats < 0)
            ...
            Log.e(TAG, "CameraHdAudioOutput.write() called with invalid array, offset, or size");
            return ERROR_BAD_VALUE;
        }
    ...
    public int write(ByteBuffer audioData, int sizeInBytes,
        ...
        if ( (audioData == null) || (sizeInBytes < 0) || (sizeInBytes > audioData.remaining())) {
            Log.e(TAG, "CameraHdAudioOutput.write() called with invalid size (" + sizeInBytes + ") value");
            return ERROR_BAD_VALUE;
        }
     ...
     * an CameraHdAudioOutput has reached a notification marker or has increased by a certain period.
     */
    public interface OnPlaybackPositionUpdateListener  {
         ...
         */
        void onMarkerReached(CameraHdAudioOutput track);

        /**
         * Called on the listener to periodically notify it that the playback head has reached
         * a multiple of the notification period.
         */
        void onPeriodicNotification(CameraHdAudioOutput track);
    }
    ...
    private class NativeEventHandlerDelegate {
        ...
        NativeEventHandlerDelegate(final CameraHdAudioOutput track,
            ...
            if (handler != null) {
                ...
                // no given handler, use the looper the CameraHdAudioOutput was created in
    ...
    //--------------------
    @SuppressWarnings("unused")
    private static void postEventFromNative(Object CameraHdAudioOutput_ref,
            int what, int arg1, int arg2, Object obj) {
        //logd("Event posted from the native side: event="+ what + " args="+ arg1+" "+arg2);
        CameraHdAudioOutput track = (CameraHdAudioOutput)((WeakReference)CameraHdAudioOutput_ref).get();
        if (track == null) {
            return;
        }
    ...
    private native final int native_setup(Object /*WeakReference<CameraHdAudioOutput>*/ CameraHdAudioOutput_this,
